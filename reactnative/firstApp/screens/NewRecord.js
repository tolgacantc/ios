...
export default class NewRecord extends React.Component {
    ...
    render() {
        ...
        const handleConfirm = date => {
            this.setState({
                actionTime: date,
                actionTimeStr: Moment(date).format(FORMATS['datetime'])
            });
            hideDatePicker();
        };
        ...
        return ( <
            ...
            <
            ActionDropDown valueChangeAction = {
                this.onValueChange
            }
            />
            ...
            title = {
                this.state.actionTimeStr
            }
            />

            <
            DateTimePickerModal isVisible = {
    ...
    return ( <
        ...
        items = {
            [{
                ...
                {
                    label: 'Breast Feeding Start',
                    value: 'BREAST_FEEDING_START'
                },
                {
                    label: 'Breast Feeding End',
                    value: 'BREAST_FEEDING_END'
                },
                {
                    label: 'Snack Start',
                    value: 'SNACK_START'
